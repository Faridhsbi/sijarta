    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saldo_my_pay', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('role', models.CharField(choices=[('pengguna', 'Pengguna'), ('pekerja', 'Pekerja')], max_length=10)),
